...
const TManagement = ({
  ...
  return (
    <div className="py-20">
      <Header
        content={"Time Management: Learning Goal"}
        textEnter={textEnter}
        textLeave={textLeave}
      />
      <NarrowParagraph
      ...
      <WideParagraph
        ...
        textLeave={textLeave}
      />
      <div className="py-10 mix-blend-difference mt-10 bg-pattern-7 bg-opacity-40 flex justify-center items-center">
        <div className="bg-background p-12 rounded-xl w-fit h-fit flex justify-center flex-col items-center">
          ...
          <WideParagraph
            ...
            text={
              <div className="mt-2">
                ...
                <p className="mb-4">
                  Enter productivity expert Dave Crenshaw&apos;s course, where
                  he unveils the secrets to achieving more in less time,
                  granting you that elusive extra free time. The course not only
                  establishes the theoretical foundations of productivity but
                  also delves into practical strategies for overcoming
                  obstacles. (LinkedIn Learning 2023.)
                </p>

                <p className=" font-bold mb-4">
                  Crenshaw&apos;s teachings are structured around three main
                ...
                <p className="mb-4">
                  ...
                  to-dos from your mind. Finally, the course instructs on
                  creating a time budget, ensuring maximum efficiency during
                  your workday and prioritizing your most valuable activities.
                ...
                <p className="mb-4">
                  ...
                  theoretical knowledge. I, for instance, enrolled in the
                  &quot;Time Management Fundamentals&quot; course to enhance my
                  time management skills. The course, comprising an
                  introduction, 10 chapters, and a conclusion.
                </p>

                <p className="mb-4">
                  Upon completing the course, I gained valuable information on
                  how to manage my time, how to keep a work-life balance, and
                  how to be stress-resilient. To validate my completion, I
                  received a certificate for the &quot;Time Management
                  Fundamentals&quot; course.
                </p>
              </div>
            }
          ...
          <NarrowParagraph
            ...
            text={
              <div className=" mt-8">
                <p className="mb-4">
                  Each section during the course, I needed to complete the quiz
                  to ensure that the information provided in the course was
                  understood, and I got it.
                </p>
                ...
                <p className="mb-4">
                  I took a total of 11 quizzes, and I needed to get 76% correct
                  on each quiz to pass the course.
                </p>
              </div>
            }
            textColor="accent"
          ...
          <NarrowParagraph
            ...
            text={
              <div className=" mt-8">
                Example of Assignment In this assignment, I had to draw up a
                work schedule in such a way that my time would be allocated to
                work and to my personal life. The purpose of the assignment was
                to maintain a balance between work and personal life. I also
                took tests to identify results in improving productivity and
                devoted approx. 5 hours a week of time management processes.
              </div>
            }
            textColor="accent"
            textPosition="left"
          ...
          <NarrowParagraph
            ...
            text={
              <div className="mt-8">
                ...
                optional Tip&apos;s videos. To get the full scope of knowledge,
                I watched about 10 videos with tips on how to better cope with
                stress and how to use time correctly with maximum productivity.
                At the end of the course, there was an exam of about 35
                questions that had to be answered correctly by 65%, In the end,
                I successfully passed the exam and received a certificate of
                completion of the course with international accreditation.
              </div>
            }
            textColor="accent"
            textPosition="right"
              ...
              <div className="mt-8">
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    delving into the principles of time management. It explores
                    the concept that effective time management is not merely
                    about squeezing more tasks into a day but involves
                    prioritizing and allocating time to activities that align
                    with overarching goals. Crenshaw emphasizes the importance
                    of distinguishing between tasks that are urgent and those
                    that are truly important, drawing on the Eisenhower Matrix
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    fundamental pillars of productivity enhancement. It
                    commences with insights on developing habits to declutter
                    workspaces, fostering organizational skills that serve as a
                    cornerstone for efficient time management. Participants
                    learn to create a conducive work environment that minimizes
                    distractions and optimizes focus.
                  </p>
                  <p className="mb-4">
                    The subsequent section of the course explores methods to
                    stay mentally focused, addressing the pitfalls of
                    switchtasking is a concept introduced in the course.
                    Switchtasking, as elucidated by Crenshaw, involves rapidly
                    shifting attention between tasks, leading to reduced
                    efficiency and increased stress. The course educates
                    participants on the detriments of this practice and provides
                    alternatives to maintain a concentrated workflow.
                  </p>
                  <p className="mb-4">
                    Finally, the course guides participants in creating a time
                    budget, a strategic tool for allocating time to activities
                    that yield the highest returns. This practical approach
                    ensures maximum efficiency during the workday, emphasizing
                    the importance of prioritizing tasks based on their value.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    The outlined learning objectives - discovering time
                    management principles, recognizing the ineffectiveness of
                    switchtasking, and creating a focused schedule and workspace
                    - underscore the practical application of the course.
                    Participants engage in quizzes, tasks, and assignments, such
                    as the creation of a balanced work schedule, reinforcing the
                    theoretical concepts learned throughout the course.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    quizzes, each demanding a minimum of 76% correct answers.
                    The inclusion of a final exam adds an additional layer of
                    ...
                    attainment of a certificate, validating the
                    participant&apos;s mastery of the course content.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    As the course&apos;s instructor, Dave Crenshaw, an
                    accomplished author and leadership coach specializing in
                    productive leadership, imparts a wealth of expertise. His
                    guidance aligns with contemporary theories on time
                    management, emphasizing the symbiotic relationship between
                    effective time utilization and achieving long-term
                    objectives.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    participants with additional insights on stress management
                    and strategies for maximizing productivity. These videos
                    contribute to a well-rounded understanding of time
                    management, addressing the psychological and emotional
                    aspects that can impact one&apos;s ability to manage time
                    effectively.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    allowed for a tangible transformation in time management
                    skills. The incorporation of theoretical concepts, combined
                    with hands-on tasks and assessments, created a comprehensive
                    learning experience. By dedicating approximately 5 hours per
                    week to the time management processes, the course not only
                    enhanced my ability to manage time but also fostered a sense
                    of work-life balance and stress resilience.
                  </p>
                </section>

                <p className="mb-4">
                  The &quot;Time Management Fundamentals&quot; course provides
                  an intricate tapestry of theoretical knowledge and practical
                  ...
                  participants with the necessary tools to navigate the
                  complexities of modern life, enabling them to achieve more in
                  less time while fostering a sustainable and balanced
                  lifestyle.
                </p>
              </div>
            }
